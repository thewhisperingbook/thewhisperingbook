...
This is a "microservice" based application intended to be part of a microservice architecture, please refer to the [Doing microservices with JHipster][] page of the documentation for more information.
...
To build the final jar and optimize the TheWhisperingBook application for production, run:
